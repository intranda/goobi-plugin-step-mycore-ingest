...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="/">
        <xsl:variable name="title" select="/mets:mets/mets:dmdSec/mets:mdWrap/mets:xmlData/mods:mods/mods:part/mods:detail/mods:number"/>
        <xsl:variable name="date" select="/mets:mets/mets:dmdSec/mets:mdWrap/mets:xmlData/mods:mods/mods:originInfo/mods:dateIssued"/>
        <!-- 
